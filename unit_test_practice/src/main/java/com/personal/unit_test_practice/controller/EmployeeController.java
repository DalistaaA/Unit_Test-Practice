...
public class EmployeeController {
	...
	@GetMapping("{id}")
	public ResponseEntity<Employee> getByEmployeeId(@PathVariable("id") long employeeId,
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable("id") long employeeId,
		...
		return employeeService.getEmployeeById(employeeId).map(savedEmployee -> {
			...
			Employee updatedEmployee = employeeService.updateEmployee(employeeId, savedEmployee);
